<?php
/**
 * @author      Josh Cranwell <josh@docker-wordpress.com>
 * @copyright   Docker WordPress
 * @version     1.0
...
class Mail {
     ...
     * @return void
     */
    public function action_phpmailer_init($phpmailer): void
    {
     ...
     * @return string
     */
    public function filter_wp_mail_from(): string
    {
     ...
     * @return void
     */
    public function action_wp_mail_failed($wp_error): void
    {
